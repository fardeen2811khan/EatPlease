...
export default function Cart() {
  ...
  const handleCheckOut = async () => {
    ...
    console.log("hehehe",localStorage.getItem("useremail"))
  ...
  let totalPrice = data.reduce((total, food) => {
    // console.log('Food:', food); // Log each food object
    // console.log('Price:', food.price); // Log price for debugging
    return total + (parseFloat(food.price) || 0); // Ensure price is parsed as a float
  }, 0);  return (
    <div>
