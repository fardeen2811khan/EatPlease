            ...
            <div id="carouselExampleFade" className="carousel slide carousel-fade " data-bs-ride="carousel">
                ...
                <div className="carousel-inner " id='carousel'>
                    ...
                    <div className="carousel-item">
                        <img src="https://source.unsplash.com/random/900x700/?donuts" className="d-block w-100 " style={{ filter: "brightness(50%)" }} alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="https://source.unsplash.com/random/900x700/?pasta" className="d-block w-100 " style={{ filter: "brightness(50%)" }} alt="..." />
                    </div>
                </div>
